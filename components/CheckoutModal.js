    ...
    >
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <button type="button" onClick={onClose} style={{ background: "none", border: "none", fontSize: "18px", cursor: "pointer", color: "#7A6A80" }}>
            ✕
          </button>
        </div>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
            ...
            {savedDetails && (
              <button
                ...
                style={{
                  background: "none", border: "none", color: "#22112B", fontSize: "12px",
