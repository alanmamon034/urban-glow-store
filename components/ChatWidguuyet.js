  ...
  return (
    ...
    >
      ...
      <div ref={scrollRef} style={{ height: "280px", overflowY: "auto", padding: "12px", display: "flex", flexDirection: "column", gap: "8px" }}>
        ...
        {uploading && (
          <div style={{ alignSelf: "flex-end", fontSize: "12px", color: "#7A6A80" }}>Uploading…</div>
        )}
      </div>

      <div style={{ display: "flex", alignItems: "center", borderTop: "1px solid #22112B22", padding: "8px", gap: "6px" }}>
        <input
          type="file"
          accept="image/*,video/*"
          ref={fileInputRef}
        ...
        <button
          ...
          style={{
            border: "1px solid #22112B33", background: "none", borderRadius: "6px",
